...
export default function OldCarsPage() {
    ...
    return (
        <>
            <SEO
                title="Used Cars | Certified Pre-Owned Vehicles at Priti-Naixa"
                description="Browse high-quality, certified used cars at Priti-Naixa Showroom. Affordable options with full T-Permit and registration support."
                keywords="used cars, pre-owned vehicles, second-hand cars, certified used cars, T-permit used cars"
                url="https://pritinaixa.com/old-cars"
                image="/banner1.png"
            />
