...
export async function generateMetadata({ params }: { params: { id: string } }) {
  ...
  if (!car) {
    return {
      ...
      alternates: {
        canonical: "https://pritinaixa.com/new_cars",
      },
    };
  }
  ...
  return (
    <>
      <SEO
        ...
        keywords={`${car.name}, T-permit cars, buy ${car.name}, T-permit vehicle showroom, Priti-Naixa`}
        url={`https://pritinaixa.com/new_cars/${car.id}`}
        image={car.images[0]}
      />
      <div
