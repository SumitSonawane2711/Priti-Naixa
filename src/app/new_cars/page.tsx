...
export default function NewCarsPage() {
    ...
    return (
        <>
            <SEO
                title="New Cars | Priti-Naixa Showroom Maharashtra"
                description="Discover brand new T-permit cars from trusted brands at Priti-Naixa Showroom. Get expert help with registration, permits, and financing for your new vehicle."
                keywords="new T-permit cars, T-permit car showroom, T-permit car Maharashtra, vehicle financing, T-permit cars"
                url="https://pritinaixa.com/new_cars"
                image="/banner1.png"
            />
                    ...
                    >
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                            {groupedCars[activeBrand].map((car, index) => (
                                <Link href={`/new_cars/${car.id}`} key={car.id} className="no-underline">
                                    <motion.div
                                        key={car.id}
