...
const faqs = [
  ...
  // 📍 Locations & Enquiries
  {
    ...
    answer:
      "We are based in Pune, Maharashtra, and operate across nearby cities including Mumbai, Nashik, and Kolhapur.",
  },
  {
    id: 8,
    question: "How can I make a booking or enquiry?",
    answer:
      "You can book directly from our website’s booking form or contact us via WhatsApp, call, or email for quick assistance.",
  },
  {
    id: 9,
